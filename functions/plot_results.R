...
plot_results <- function(
  ...
  if (non_park_comparison) {
    ...
    df_sex <- extract_reg_coeffs(
      "Sex",
      levels(df_filtered$Sex),
      coeffs,
      summ
    )
    ...
    df_coeffs <- rbind(df_park, df_empty1, df_age, df_empty2, df_sex)
    ...
    coeff_plot_title <- "Park, sex and age regression coefficients"
